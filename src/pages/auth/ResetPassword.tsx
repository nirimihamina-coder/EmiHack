        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
          {success ? (
            <div className="text-center py-4">
              ...
              <h2 className="text-lg font-medium text-gray-900 mb-2">Mot de passe réinitialisé !</h2>
            ...
            <>
              ...
              <h1 className="text-xl font-medium text-gray-900 mb-1">Nouveau mot de passe</h1>
              <p className="text-sm text-gray-500 mb-7">Choisissez un mot de passe sécurisé.</p>
              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
                ...
                {/* Confirmer */}
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="confirm" className="text-xs font-medium text-gray-600">
